            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-5'>
                <div className='flex gap-2'>
                    ...
                    <div>
                        ...
                        <h2 className='font-medium text-lg text-gray-900'>{course?.level}</h2>
                    </div>
                </div>
                <div className='flex gap-2'>
                    ...
                    <div>
                        ...
                        <h2 className='font-medium text-lg text-gray-900'>{calculateTotalDuration()}</h2>
                    </div>
                </div>
                <div className='flex gap-2'>
                    ...
                    <div>
                        ...
                        <h2 className='font-medium text-lg text-gray-900'>{course?.courseOutput?.[0]?.no_of_chapters}</h2>
                    </div>
                </div>
                <div className='flex gap-2'>
                    ...
                    <div>
                        ...
                        <h2 className='font-medium text-lg text-gray-900'>{course?.includeVideo}</h2>
                    </div>
                </div>
            </div>
        </div>
