                    ...
                    {Menu.map((item) => {
                        ...
                        return (
                            <li key={item.id}>
                                <Link
                                    href={item.path}
                                    className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 hover:shadow-sm ${isActive
                                            ? 'bg-gradient-to-r from-purple-50 to-blue-50 text-purple-700 shadow-sm'
                                            : 'text-gray-600 hover:text-purple-700'
                                        }`}
                                >
                                    <div
                                        className={`transition-transform duration-200 group-hover:scale-110 ${isActive ? 'text-purple-600' : ''
                                            }`}
                                    >
                                        {item.icon}
                                    </div>
