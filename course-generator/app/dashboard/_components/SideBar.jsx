...
import { Home, Search, Crown, LogOut, Sparkles } from 'lucide-react';
    ...
    return (
        <div className='fixed h-full md:w-64 bg-white border-r border-gray-200 shadow-sm'>
                        ...
                        <li key={item.id}> 
                            <a 
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 hover:shadow-sm ${
                                    item.id === 1 ? 'bg-gradient-to-r from-purple-50 to-blue-50 text-purple-700 shadow-sm' : 'text-gray-600 hover:text-purple-700'
                                }`}
                            >
                                <div className={`transition-transform duration-200 group-hover:scale-110 ${
                                    item.id === 1 ? 'text-purple-600' : ''
                                }`}>
                                    {item.icon}
                                </div>
            ...
            <div className='absolute bottom-4 left-4 right-4'>
                ...
                <h2 className='text-xs text-gray-600 mb-3'>3 Out of 5 Course created</h2>
